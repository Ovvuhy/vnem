...
Generated: 2026-06-23T18:55:15.829Z
...
Opt-in Tools MCP foundation for a project that should allow bounded approved file reads/searches, dry-run-first patches, approved restore from backups, allowlisted commands, approved GET/HEAD API requests, approved local browser screenshots, and proof-compatible evidence logs:

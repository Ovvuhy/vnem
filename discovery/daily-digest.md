...
Generated: 2026-06-28T09:30:00.000Z
...
- Chrome DevTools MCP | promising | official | https://github.com/ChromeDevTools/chrome-devtools-mcp
- Nx MCP | promising | official | https://github.com/nrwl/nx
- robota | unreviewed | review | https://github.com/woojubb/robota
...
- ai-dev-assistant-framework | unreviewed | watchlist | https://github.com/MunnaXbadmash/ai-dev-assistant-framework
- patchloom | unreviewed | watchlist | https://github.com/patchloom/patchloom
- mcp-docstore | unreviewed | review | https://github.com/Fishwaldo/mcp-docstore
- QMP-Dynamic-Anchors | unreviewed | review | https://github.com/caihongfairys/QMP-Dynamic-Anchors
- agent-eval | unreviewed | review | https://github.com/sauravbhattacharya001/agent-eval
- registry | unreviewed | review | https://github.com/AlejandroVelezGuillermo/registry
- nx-mcp (npm) | promising | official | https://www.npmjs.com/package/nx-mcp
- chrome-devtools-mcp (npm) | promising | official | https://www.npmjs.com/package/chrome-devtools-mcp
- Show HN: Smart model routing directly in Claude, Codex and Cursor | watchlist | watchlist | https://news.ycombinator.com/item?id=48688700
- Show HN: Engye – transfer files between any two devices by scanning a QR code | watchlist | watchlist | https://news.ycombinator.com/item?id=48703194

## Promoted to Registry

- Chrome DevTools MCP | mcp-server | promoted | Google-maintained Chrome DevTools Protocol, Apache-2.0, 56 versions | https://github.com/ChromeDevTools/chrome-devtools-mcp
- Nx MCP | mcp-server | promoted | Nrwl's Nx monorepo workspace MCP server, MIT, 50 versions | https://github.com/nrwl/nx
...
- [ai.inflowpayapp/inflow](/entries/ai-inflowpay-app-inflow/) | mcp-server | promising | license-not-asserted

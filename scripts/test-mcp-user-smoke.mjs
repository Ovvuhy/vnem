...
try {
  ...
  for (const name of ["vnem_tools_permission_profiles", "vnem_tools_permission_status", "vnem_tools_reliability_catalog", "vnem_tools_action_recovery_plan", "vnem_tools_high_power_action_review", "vnem_tools_capability_gap_report", "vnem_tools_action_policy_preview", "vnem_tools_trust_boundary_classify", "vnem_tools_search_provider_manifest", "vnem_tools_search_query_builder", "vnem_tools_web_search", "vnem_tools_search_result_ranker", "vnem_tools_captcha_detector", "vnem_tools_download_safety_check", "vnem_tools_claim_source_matrix", "vnem_tools_research_gap_detector", "vnem_tools_source_map", "vnem_tools_source_extract", "vnem_tools_source_graph", "vnem_tools_architecture_review", "vnem_tools_debug_evidence", "vnem_tools_ui_surface_review", "vnem_tools_browser_evidence_plan", "vnem_tools_browser_evidence_run", "vnem_tools_ui_evidence_audit", "vnem_tools_cloudflare_status", "vnem_tools_cloudflare_auth_plan", "vnem_tools_cloudflare_pages_deploy_plan", "vnem_tools_cloudflare_dns_plan", "vnem_tools_cloudflare_env_plan", "vnem_tools_evidence_pack_audit", "vnem_tools_mutation_approval_contract", "vnem_tools_secret_redaction_check"]) assert.ok(toolNames.includes(name), `manifest missing ${name}`);

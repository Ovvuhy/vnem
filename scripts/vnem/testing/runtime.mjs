...
function applyIntegrationBoundaries(changed, add) {
  const rules = [
    ...
    [/^scripts\/vnem\/core\/server\.mjs$/, ["test:vnem-adoption-reliability-2-regression", "test:giga-adoption-client-use"]],
    [/^scripts\/vnem-install-adoption\.mjs$/, ["test:vnem-install-adoption-1-regression", "test:giga-adoption-client-use"]],

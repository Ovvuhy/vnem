...
export const GIGA_SCENARIOS = [
  ...
  scenario("safe-refactor", "safe refactoring", "Refactor duplicated handlers without changing public MCP behavior and select regression tests.", ["vnem_tools_structural_index_build", "vnem_tools_refactor_impact_analyze"], { required_tools: ["vnem_tools_structural_index_build", "vnem_tools_refactor_impact_analyze", "vnem_tools_structural_patch_validate", "vnem_tools_test_selection_plan"] }),
  ...
  scenario("dependency-risk", "dependency/install risk", "Audit dependency and install-script risk without installing packages.", ["vnem_tools_dependency_inventory", "vnem_tools_dependency_risk_audit", "vnem_tools_dependency_advisory_audit"]),
  scenario("package-upgrade", "package upgrade planning", "Plan a safe package upgrade with changelog, compatibility, tests, and rollback.", ["vnem_tools_dependency_change_analyze", "vnem_tools_dependency_upgrade_plan", "vnem_tools_dependency_install_apply"], { rollback_expected: true }),
  scenario("api-selection", "API selection and integration", "Select a suitable API, review trust and auth needs, then build an integration plan.", ["vnem_tools_api_adapter_catalog", "vnem_tools_api_adapter_plan"], { required_tools: ["vnem_tools_api_adapter_catalog", "vnem_tools_api_adapter_plan"] }),
  scenario("live-api", "approved live API execution", "Execute an explicitly approved allowlisted GET API request with redaction and evidence.", ["vnem_tools_api_adapter_execute", "vnem_tools_evidence_pack"], { permission_expected: true, required_tools: ["vnem_tools_api_adapter_catalog", "vnem_tools_api_adapter_plan", "vnem_tools_api_adapter_execute", "vnem_tools_evidence_pack"] }),
  scenario("skill-selection", "skill selection", "Select a vetted agent skill adapter from its catalog, verify doctor readiness, inspect its package trust, and plan it without executing upstream Markdown.", ["vnem_tools_skill_adapter_catalog", "vnem_tools_skill_doctor"], { task_mode: "skill", required_tools: ["vnem_tools_skill_adapter_catalog", "vnem_tools_skill_doctor", "vnem_tools_skill_package_inspect", "vnem_tools_skill_adapter_plan"] }),
  scenario("skill-execution", "vetted skill execution", "Execute a vetted skill adapter with bounded input and exact permission evidence while keeping untrusted Markdown inert.", ["vnem_tools_skill_adapter_plan", "vnem_tools_skill_adapter_execute"], { task_mode: "skill", permission_expected: true, required_tools: ["vnem_tools_skill_adapter_catalog", "vnem_tools_skill_doctor", "vnem_tools_skill_adapter_plan", "vnem_tools_skill_adapter_execute"] }),

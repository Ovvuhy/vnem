...
function coreMode(mode) {
  const map = { debugging: "debugging", publish: "publish", recovery: "recovery", browser_ui: "ui_browser" };
  return map[mode] || "auto";
}

function toolsMode(mode) {
  const supported = new Set(["auto", "implementation", "debugging", "repo_inspection", "patch_targeting", "mcp_tool_audit", "publish", "cloudflare", "browser_ui", "recovery", "no_placebo", "evidence_pack"]);

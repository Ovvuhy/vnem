...
| --- | --- | --- | --- | --- | --- | --- | --- |
| core | `vnem_bootstrap` | bootstrap | read_only | allowed_root_read | optional | not_required | scripts/vnem/core/bootstrap-runtime.mjs |
...
| core | `vnem_mcp_visibility_doctor` | mcp | read_only | allowed_root_read | optional | not_required | scripts/vnem/core/adoption-runtime.mjs |
| core | `vnem_underuse_detector` | underuse | read_only | allowed_root_read | optional | not_required | scripts/vnem/core/adoption-runtime.mjs |
| core | `vnem_usage_self_check` | usage | read_only | allowed_root_read | optional | not_required | scripts/vnem/core/adoption-runtime.mjs |
...
| core | `vnem_route_task` | route | read_only | allowed_root_read | optional | not_required | scripts/vnem/core/planning-domains.mjs |
| core | `vnem_output_quality_plan` | output | read_only | allowed_root_read | optional | not_required | scripts/vnem/core/planning-domains.mjs |
| core | `vnem_anti_stagnation_check` | anti | read_only | allowed_root_read | optional | not_required | scripts/vnem/core/planning-domains.mjs |
| core | `vnem_plan_effort_budget` | plan | read_only | allowed_root_read | optional | not_required | scripts/vnem/core/planning-domains.mjs |
| core | `vnem_fast_answer_contract` | fast | read_only | allowed_root_read | optional | not_required | scripts/vnem/core/planning-domains.mjs |
| core | `vnem_design_ambition_plan` | design | read_only | allowed_root_read | optional | not_required | scripts/vnem/core/planning-domains.mjs |
| core | `vnem_visual_taste_audit` | visual | read_only | allowed_root_read | optional | not_required | scripts/vnem/core/planning-domains.mjs |
| core | `vnem_redesign_comparison_scorecard` | redesign | read_only | allowed_root_read | optional | not_required | scripts/vnem/core/planning-domains.mjs |
| core | `vnem_total_impact_design_plan` | total | read_only | allowed_root_read | optional | not_required | scripts/vnem/core/planning-domains.mjs |
| core | `vnem_design_direction_selector` | design | read_only | allowed_root_read | optional | not_required | scripts/vnem/core/planning-domains.mjs |
| core | `vnem_compact_output_contract` | compact | read_only | allowed_root_read | optional | not_required | scripts/vnem/core/planning-domains.mjs |
| core | `vnem_build_debugging_plan` | build | read_only | allowed_root_read | optional | not_required | scripts/vnem/core/planning-domains.mjs |
| core | `vnem_evidence_to_fix_check` | evidence | read_only | allowed_root_read | optional | not_required | scripts/vnem/core/planning-domains.mjs |
| core | `vnem_build_architecture_map` | build | read_only | allowed_root_read | optional | not_required | scripts/vnem/core/planning-domains.mjs |
| core | `vnem_code_change_contract` | code | read_only | allowed_root_read | optional | not_required | scripts/vnem/core/planning-domains.mjs |
| core | `vnem_build_ui_quality_plan` | build | read_only | allowed_root_read | optional | not_required | scripts/vnem/core/planning-domains.mjs |
| core | `vnem_visual_proof_contract` | visual | read_only | allowed_root_read | optional | not_required | scripts/vnem/core/planning-domains.mjs |
| core | `vnem_select_tools_for_task` | select | read_only | allowed_root_read | optional | not_required | scripts/vnem/core/planning-domains.mjs |
| core | `vnem_build_tools_plan` | build | read_only | allowed_root_read | optional | not_required | scripts/vnem/core/planning-domains.mjs |
| core | `vnem_build_browser_research_plan` | browser | read_only | approved_network_read | optional | not_required | scripts/vnem/core/planning-domains.mjs |
| core | `vnem_assess_research_need` | research | read_only | allowed_root_read | optional | not_required | scripts/vnem/core/planning-domains.mjs |
| core | `vnem_build_search_plan` | build | read_only | allowed_root_read | optional | not_required | scripts/vnem/core/planning-domains.mjs |
| core | `vnem_build_browsing_plan` | build | read_only | allowed_root_read | optional | not_required | scripts/vnem/core/planning-domains.mjs |
| core | `vnem_build_research_strategy` | research | read_only | allowed_root_read | optional | not_required | scripts/vnem/core/planning-domains.mjs |
| core | `vnem_build_source_ingestion_plan` | source | read_only | allowed_root_read | optional | not_required | scripts/vnem/core/planning-domains.mjs |
| core | `vnem_research_evidence_audit` | research | read_only | allowed_root_read | optional | not_required | scripts/vnem/core/planning-domains.mjs |
| core | `vnem_explain_tools_chain` | explain | read_only | allowed_root_read | optional | not_required | scripts/vnem/core/planning-domains.mjs |
...
| tools | `vnem_tools_entrypoint` | entrypoint | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/adoption-runtime.mjs |
| tools | `vnem_tools_capability_router` | capability | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/adoption-runtime.mjs |
| tools | `vnem_tools_adoption_readiness` | adoption | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/adoption-runtime.mjs |
| tools | `vnem_tools_visibility_doctor` | visibility | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/adoption-runtime.mjs |
| tools | `vnem_tools_underuse_detector` | underuse | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/adoption-runtime.mjs |
...
| tools | `vnem_tools_client_detect` | client | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/client-setup.mjs |
| tools | `vnem_tools_client_setup_plan` | client | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/client-setup.mjs |
| tools | `vnem_tools_client_install` | install | destructive_mutation | approved_local_mutation | required_redacted_record | required_or_explicitly_not_available | scripts/vnem/tools/client-setup.mjs |
| tools | `vnem_tools_client_setup_status` | client | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/client-setup.mjs |
| tools | `vnem_tools_client_verify` | client | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/client-setup.mjs |
| tools | `vnem_tools_client_rollback` | client | destructive_mutation | approved_local_mutation | required_redacted_record | self | scripts/vnem/tools/client-setup.mjs |
...
| tools | `vnem_tools_reliability_catalog` | reliability | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/reliability-runtime.mjs |
| tools | `vnem_tools_action_recovery_plan` | action | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/reliability-runtime.mjs |
| tools | `vnem_tools_high_power_action_review` | high | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/reliability-runtime.mjs |
| tools | `vnem_tools_capability_gap_report` | capability | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/reliability-runtime.mjs |
| tools | `vnem_tools_repo_deep_map` | repo | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/repo-intelligence-runtime.mjs |
| tools | `vnem_tools_next_action_ranker` | next | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/repo-intelligence-runtime.mjs |
| tools | `vnem_tools_no_placebo_progress_audit` | no | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/repo-intelligence-runtime.mjs |
| tools | `vnem_tools_change_impact_plan` | change | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/repo-intelligence-runtime.mjs |
| tools | `vnem_tools_test_selection_plan` | test | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/repo-intelligence-runtime.mjs |
| tools | `vnem_tools_failure_triage` | failure | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/repo-intelligence-runtime.mjs |
| tools | `vnem_tools_evidence_pack` | evidence | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/repo-intelligence-runtime.mjs |
| tools | `vnem_tools_local_session_recovery` | local | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/repo-intelligence-runtime.mjs |
| tools | `vnem_tools_repo_workflow_orchestrator` | repo | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/repo-intelligence-runtime.mjs |
| tools | `vnem_tools_code_symbol_map` | code | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/repo-intelligence-runtime.mjs |
| tools | `vnem_tools_mcp_surface_audit` | mcp | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/repo-intelligence-runtime.mjs |
| tools | `vnem_tools_patch_target_finder` | patch | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/repo-intelligence-runtime.mjs |
| tools | `vnem_tools_tool_test_coverage_map` | tool | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/repo-intelligence-runtime.mjs |
| tools | `vnem_tools_source_impact_trace` | source | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/repo-intelligence-runtime.mjs |
| tools | `vnem_tools_source_control_character_guard` | source | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/repo-intelligence-runtime.mjs |
...
| tools | `vnem_tools_skill_adapter_catalog` | skill | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/server.mjs |
| tools | `vnem_tools_skill_package_inspect` | skill | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/server.mjs |
| tools | `vnem_tools_skill_doctor` | skill | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/server.mjs |
...
| tools | `vnem_tools_browser_page_inspect` | browser | read_only | approved_network_read | optional | not_required | scripts/vnem/tools/browser-research-runtime.mjs |
| tools | `vnem_tools_browser_readability_extract` | browser | read_only | approved_network_read | optional | not_required | scripts/vnem/tools/browser-research-runtime.mjs |
| tools | `vnem_tools_browser_link_map` | browser | read_only | approved_network_read | optional | not_required | scripts/vnem/tools/browser-research-runtime.mjs |
| tools | `vnem_tools_browser_dom_search` | browser | read_only | approved_network_read | optional | not_required | scripts/vnem/tools/browser-research-runtime.mjs |
| tools | `vnem_tools_browser_accessibility_audit` | browser | read_only | approved_network_read | optional | not_required | scripts/vnem/tools/browser-research-runtime.mjs |
| tools | `vnem_tools_browser_compare_snapshots` | browser | read_only | approved_network_read | optional | not_required | scripts/vnem/tools/browser-research-runtime.mjs |
| tools | `vnem_tools_browser_research_pack` | browser | read_only | approved_network_read | optional | not_required | scripts/vnem/tools/browser-research-runtime.mjs |
| tools | `vnem_tools_search_provider_manifest` | search | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/source-research-runtime.mjs |
| tools | `vnem_tools_search_query_builder` | search | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/source-research-runtime.mjs |
| tools | `vnem_tools_web_search` | web | read_only | approved_network_read | optional | not_required | scripts/vnem/tools/source-research-runtime.mjs |
| tools | `vnem_tools_search_result_ranker` | search | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/source-research-runtime.mjs |
| tools | `vnem_tools_redirect_chain_check` | redirect | read_only | approved_network_read | optional | not_required | scripts/vnem/tools/source-research-runtime.mjs |
| tools | `vnem_tools_url_reputation_check` | url | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/source-research-runtime.mjs |
| tools | `vnem_tools_captcha_detector` | captcha | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/source-research-runtime.mjs |
| tools | `vnem_tools_download_safety_check` | download | read_only | approved_network_read | optional | not_required | scripts/vnem/tools/source-research-runtime.mjs |
| tools | `vnem_tools_claim_source_matrix` | source | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/source-research-runtime.mjs |
| tools | `vnem_tools_research_gap_detector` | research | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/source-research-runtime.mjs |
| tools | `vnem_tools_source_map` | source | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/source-research-runtime.mjs |
| tools | `vnem_tools_source_extract` | source | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/source-research-runtime.mjs |
| tools | `vnem_tools_source_graph` | source | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/source-research-runtime.mjs |
...
| tools | `vnem_tools_source_quality_check` | source | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/browser-research-runtime.mjs |
| tools | `vnem_tools_research_brief` | research | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/browser-research-runtime.mjs |
...
| tools | `vnem_tools_github_repo_inspect` | github | read_only | approved_network_read | optional | not_required | scripts/vnem/tools/github-operations-runtime.mjs |
| tools | `vnem_tools_github_diff_review` | github | read_only | approved_network_read | optional | not_required | scripts/vnem/tools/github-operations-runtime.mjs |
| tools | `vnem_tools_github_review_threads` | github | read_only | approved_network_read | optional | not_required | scripts/vnem/tools/github-operations-runtime.mjs |
| tools | `vnem_tools_github_remote_proof` | github | read_only | approved_network_read | optional | not_required | scripts/vnem/tools/github-operations-runtime.mjs |
| tools | `vnem_tools_github_actions_run_inspect` | github | read_only | approved_network_read | optional | not_required | scripts/vnem/tools/github-operations-runtime.mjs |
| tools | `vnem_tools_github_release_verify` | github | read_only | approved_network_read | optional | not_required | scripts/vnem/tools/github-operations-runtime.mjs |
| tools | `vnem_tools_github_public_surface_audit` | github | read_only | approved_network_read | optional | not_required | scripts/vnem/tools/github-operations-runtime.mjs |
| tools | `vnem_tools_repo_intelligence_report` | repo | read_only | approved_network_read | optional | not_required | scripts/vnem/tools/github-operations-runtime.mjs |
| tools | `vnem_tools_github_branch_create` | github | destructive_mutation | approved_local_mutation | required_redacted_record | required_or_explicitly_not_available | scripts/vnem/tools/github-operations-runtime.mjs |
| tools | `vnem_tools_github_commit_push` | github | network_mutation | approved_network_mutation, scoped_credential_reference | required_redacted_record | required_or_explicitly_not_available | scripts/vnem/tools/github-operations-runtime.mjs |
| tools | `vnem_tools_github_pr_create` | github | network_mutation | approved_network_mutation, scoped_credential_reference | required_redacted_record | required_or_explicitly_not_available | scripts/vnem/tools/github-operations-runtime.mjs |
| tools | `vnem_tools_github_pr_update` | github | network_mutation | approved_network_mutation, scoped_credential_reference | required_redacted_record | required_or_explicitly_not_available | scripts/vnem/tools/github-operations-runtime.mjs |
| tools | `vnem_tools_github_issue_create` | github | network_mutation | approved_network_mutation, scoped_credential_reference | required_redacted_record | required_or_explicitly_not_available | scripts/vnem/tools/github-operations-runtime.mjs |
| tools | `vnem_tools_github_issue_update` | github | network_mutation | approved_network_mutation, scoped_credential_reference | required_redacted_record | required_or_explicitly_not_available | scripts/vnem/tools/github-operations-runtime.mjs |
| tools | `vnem_tools_github_issue_comment` | github | read_only | approved_network_read | optional | not_required | scripts/vnem/tools/github-operations-runtime.mjs |
| tools | `vnem_tools_github_labels_manage` | github | read_only | approved_network_read | optional | not_required | scripts/vnem/tools/github-operations-runtime.mjs |
| tools | `vnem_tools_github_actions_status` | github | read_only | approved_network_read | optional | not_required | scripts/vnem/tools/github-operations-runtime.mjs |
| tools | `vnem_tools_github_actions_rerun` | github | read_only | approved_network_read | optional | not_required | scripts/vnem/tools/github-operations-runtime.mjs |
| tools | `vnem_tools_github_ci_failure_triage` | github | read_only | approved_network_read | optional | not_required | scripts/vnem/tools/github-operations-runtime.mjs |
| tools | `vnem_tools_pr_quality_gate` | pr | read_only | allowed_root_read | optional | not_required | scripts/vnem/tools/github-operations-runtime.mjs |
...
| tools | `vnem_tools_github_release_plan` | github | read_only | approved_network_read | optional | not_required | scripts/vnem/tools/github-operations-runtime.mjs |
| tools | `vnem_tools_github_release_create` | github | network_mutation | approved_network_mutation, scoped_credential_reference | required_redacted_record | required_or_explicitly_not_available | scripts/vnem/tools/github-operations-runtime.mjs |
| tools | `vnem_tools_github_repo_settings_plan` | github | read_only | approved_network_read | optional | not_required | scripts/vnem/tools/github-operations-runtime.mjs |
| tools | `vnem_tools_github_repo_settings_apply` | github | network_mutation | approved_network_mutation, scoped_credential_reference | required_redacted_record | required_or_explicitly_not_available | scripts/vnem/tools/github-operations-runtime.mjs |
